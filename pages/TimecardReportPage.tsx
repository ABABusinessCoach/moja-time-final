                  ...
                  >
                    ...
                    <td className="px-2 py-2.5 text-gray-600 whitespace-nowrap">
                      {sr ? (
                        ...
                        <span className="inline-flex items-center gap-1 text-[11px] font-semibold text-moja-blue/70 hover:text-moja-orange">
                          <span className="text-base leading-none">+</span> Add hours
                        </span>
                      ) : ''}
                    </td>
